...
new WPUpdatesPluginUpdater_1121( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_1121') ) {
    class WPUpdatesPluginUpdater_1121 {
